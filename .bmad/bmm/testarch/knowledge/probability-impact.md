...
import { type Impact, type Probability, type RiskAssessment, assessRisk } from './risk-matrix'
...
import { type RiskAction, type RiskScore, classifyRiskAction } from './risk-matrix'
