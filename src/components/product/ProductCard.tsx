...
const RatingAndReview = ({
  ...
  <div className="flex items-center mb-4 gap-2">
    <div className="flex items-center gap-1">
      ...
      <span className="text-sm font-semibold text-gray-700">{product.starScore.toFixed(1)}</span>
...
const ProductInfo = ({
  ...
  <div className="p-5 flex flex-col h-auto">
    ...
    <PriceInfo product={product} showPreviousPrice={showPreviousPrice} />

    <RatingAndReview product={product} showNotificationCount={showNotificationCount} />
